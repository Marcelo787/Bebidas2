...
private val adapterBebidas1: AdapterBebidas
    get() {
        val adapterBebidas = AdapterBebidas()
        return adapterBebidas
    }
...
class ListaBebidasFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private val adapterBebidas = AdapterBebidas()

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        binding.recyclerViewBebidas.adapter = adapterBebidas1
